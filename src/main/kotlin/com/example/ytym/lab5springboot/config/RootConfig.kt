...
@Configuration
@ComponentScan(basePackages = ["com.example.ytym.lab5springboot"])
@EnableJpaRepositories(basePackages = ["com.example.ytym.lab5springboot.repository"])
class RootConfig {
    @Bean
    ...
    fun entityManagerFactory(dataSource: DataSource) =
        LocalContainerEntityManagerFactoryBean().apply {
            ...
            setPackagesToScan("com.example.ytym.lab5springboot.entity")
